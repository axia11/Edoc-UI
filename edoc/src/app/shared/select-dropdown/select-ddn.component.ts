...
@Component({
  selector: 'select-ddn',
  templateUrl: './select-ddn.component.html',
  styleUrls: ['./select-ddn.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => SelectDdnComponent),
      multi: true
    }
  ],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class SelectDdnComponent implements OnInit, OnDestroy, AfterViewInit, ControlValueAccessor {
  ...
  @ContentChild(SelectDdnClearDirective) clearIcon: SelectDdnClearDirective;
  ...
  ngOnInit() {
    ...
    if (this.addBtn) {
      this.placeholderLabel = 'Type to Search/Add';
    }
